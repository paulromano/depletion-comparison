...
# convert to time: BU = P*t/m --> t = BU*m/p
power = 174  # W/cm
mass = 1e-3*op.heavy_metal  # kg/cm
cum_days = 1e6*burnup*mass/power   # [W d/kg] [kg/cm] / [W/cm] = [d]

# Using cumulative days, get time steps in seconds
days = 24*60*60
time_steps = np.diff(cum_days, prepend=0.0) * days
